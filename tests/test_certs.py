...
class TestGoodCert(unittest.TestCase):
  def runTest(self):
    assert [] == checkCert('test', 'bear.im', debug=False)
...
class TestExpiredCert(unittest.TestCase):
	def runTest(self):
		...
		r = checkCert('test', 'expired.badssl.com', debug=False)
...
class TestSelfSignedCert(unittest.TestCase):
	def runTest(self):
		...
		r = checkCert('test', 'self-signed.badssl.com', debug=False)
...
class TestWrongHostCert(unittest.TestCase):
	def runTest(self):
		...
		r = checkCert('test', 'wrong.host.badssl.com', debug=False)
...
class TestMsgSizeCert(unittest.TestCase):
	def runTest(self):
		s = "get_peer_certificate attempt: [('SSL routines', 'ssl3_get_server_certificate', 'certificate verify failed')]"
		r = checkCert('test', 'incomplete-chain.badssl.com', debug=False)
...
class TestMsgSizeCert(unittest.TestCase):
	def runTest(self):
		...
		r = checkCert('test', '10000-sans.badssl.com', debug=False)
